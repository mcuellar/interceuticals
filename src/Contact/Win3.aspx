<%@ Page language="c#" Codebehind="Win3.aspx.cs" AutoEventWireup="false" Inherits="Interceuticals.Contact.Win3" %>
<%
...
<tr><!-- added <tr> tag -->
      <td width="20" valign="top"><img src="/interceuticals/betterman/images/lev2/white1.gif" width="20" height="43"></td>
      <td width="388" valign="top">
        <p><img src="/interceuticals/betterman/Images/lev2/headers/win3header.gif" width="389" height="22"></p>
        <h3><b>of BetterMAN®—ENTER NOW!<br >
          A $135 Value!!</b></h3>
        ...
        <p>At the end of each month, we will collect all entries for that month 
          and randomly pick out one (1) lucky winner. Winners will be contacted 
          via email to confirm delivery address for your <b>3 FREE</b> bottles of 
          BetterMAN.</p>
        <ol>
        ...
        e-Newsletters 
          ...
          <li>Please enter the following information</li>
        </ol>
      <tr></tr>
   </table>
